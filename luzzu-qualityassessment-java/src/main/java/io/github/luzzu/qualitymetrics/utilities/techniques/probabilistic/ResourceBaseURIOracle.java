package io.github.luzzu.qualitymetrics.utilities.techniques.probabilistic;
...
import io.github.luzzu.qualitymetrics.utilities.datatypes.Pair;
...
public class ResourceBaseURIOracle {
	...
	public String getEstimatedResourceDatasetURI() {
		...
		if(this.declaredResDatasetURI != null) {
			...
			if (curBestGuessURI.equals("$builderEnvironmentPropertiess")){
